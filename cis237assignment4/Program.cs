        ...
        static void Main(string[] args)
        {
            ...
            while (choice != 4)
            {
                ...
                switch (choice)
                {
                    ...
                    case 3:
                        // get what they want to sort by
                        userInterface.SortingOptions();
                        choice = userInterface.GetMenuChoice();
                        // Then once its sorted
                        // show the more specific menu and then sort it out!

                        if ( choice == 1)
                        {
                            droidCollection.BucketSortByModel();
                        }

                        else
                        {
                            droidCollection.MergeSortByTotalCost();
                        }
